...
function SearchBar() {
  return (
    <div className='searchBar grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
        <form action="">
            <div className='firstDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
                ...
                <button className='bg-blueColor h-full py-2 px-10 rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Search</button>
            </div>
        </form>
        ...
        <div className='secDiv flex items-center gap-20 justify-center'>
            ...
            <span className='text-[#a1a1a1] cursor-pointer select-none'>Clear All</span>
        </div>
